...
export function loadSave(): boolean {
	...
	gameState.board = setupPlayerIdleBoard(
		parseSerializedPlayer(save.players[0]),
	);
	gameState.stage = save.stage as GameStage;
	gameState.dialogStates = save.dialogStates;
	gameState.seed = save.seed;
	gameState.lastCaptureDestination = save.lastCaptureDestinationRef
		? DESTINATIONS[save.lastCaptureDestinationRef]
		: null;
...
function parseSerializedPokemonOnBoard(
	p: SerializedPokemonOnBoard,
): PokemonOnBoard {
