...
import { DestinationTypeSubtextColor } from "./destinationPanel";

let destinationPanel: Phaser.GameObjects.Container | null = null;

export function showDestinationNamePanel(
	...
	const subtextColor = DestinationTypeSubtextColor[destination.type];
