...
export const LIGUE: Destination = {
	...
	preload(scene: MyScene) {
		...
		scene.load.tilemapTiledJSON(
			"arene_ligue1",
			"assets/maps/arene_ligue1.json",
		);
		scene.load.tilemapTiledJSON(
			"arene_ligue2",
			"assets/maps/arene_ligue2.json",
		);
		scene.load.tilemapTiledJSON(
			"arene_ligue3",
			"assets/maps/arene_ligue3.json",
		);
		scene.load.tilemapTiledJSON(
			"arene_ligue4",
			"assets/maps/arene_ligue4.json",
		);
		scene.load.tilemapTiledJSON(
			"arene_ligue5",
			"assets/maps/arene_ligue5.json",
		);
		scene.load.tilemapTiledJSON("endroom", "assets/maps/endroom.json");
		preloadMusic(
			"music_route_victoire",
			"assets/audio/music/22 The Last Road.mp3",
		);
