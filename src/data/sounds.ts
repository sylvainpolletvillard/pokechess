...
export function loadAudio(scene: Phaser.Scene) {
    ...
    scene.load.audio("music_mont_selenite", ["assets/audio/music/39 Mt. Moon Cave.mp3"]);
    ...
    //scene.load.audio("music_safrania", ["assets/audio/music/07 Pewter City's Theme.mp3"]); // meme musique que argenta
    ...
    // unused
    //scene.load.audio("music_casino", ["assets/audio/music/36 Casino.mp3"]);
