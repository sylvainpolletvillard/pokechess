export function loadSpritesheets(scene: Phaser.Scene){
    ...
    scene.load.spritesheet('pokemon_portraits', 'assets/sprites/pokemon_portraits.png', {
        frameWidth: 64,
        frameHeight: 64,
        spacing: 1,
        margin: 0,
    ...
    scene.load.spritesheet('trainers_intros', 'assets/sprites/trainers_intros.png', {
        frameWidth: 320,
        frameHeight: 128,
        spacing: 0,
        margin: 0
