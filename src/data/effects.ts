...
export const EFFECTS: { [name: string]: Effect } = {
	...
	LANCE_SOLEIL: {
		key: "lance_soleil",
		frames: [
			89, 90, 91, 92, 93, 94, 93, 94, 93, 94, 93, 94, 93, 94, 93, 94, 93, 94,
			93, 94, 93, 94, 93, 94, 93, 94, 93, 94, 93, 94, 93, 94, 93, 94, 93, 94,
	...
	ULTRASON: {
		key: "ultrason",
		frames: [
			184, 185, 186, 187, 188, 188, 188, 188, 188, 188, 188, 188, 188, 188, 188,
	...
	E_COQUE: {
		key: "e_coque",
		frames: [
			329, 330, 331, 332, 333, 334, 335, 336, 337, 338, 339, 340, 341, 341, 341,
			341,
		],
		frameRate: 8,
		position: "source_ground",
